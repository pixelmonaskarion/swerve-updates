...
//integrate drag on top of setpoint for faster stuff later
public class Motor extends CANSparkMax {
    ...
    public static void test() {
        ...
        for (int i = 0; i < n/2; i++) {
            m[i] = new Motor(0, 1, i * 0.2, 0, 0.5);
        }
        for (int i = n/2; i < n; i++) {
            m[i] = new Motor(1, 1, 0, (i-n/2) * 0.2, 0.5);
        }
    ...
    public Motor(int id, double mass, double kdrag, double kkdrag, double force) {
    ...
    public Motor(double t0, double v0, double p0) {
        this();
        this.t = t0;
        this.velocity.reset(t0, v0);
        this.position.reset(t0, p0);
    }
    public Motor(int id, double mass, double kdrag, double kkdrag, double force, double t0, double v0, double p0) {
        this(id, mass, kdrag, kkdrag, force);
        this.t = t0;
        this.velocity.reset(t0, v0);
        this.position.reset(t0, p0);
    }
    ...
    public static class Builder {
        ...
        public Motor build() {
            return new Motor(id, mass, kdrag, kkdrag, force, t0, v0, p0);
        }
    }
}